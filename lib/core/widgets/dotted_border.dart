...
// DottedBorderWidget
class AppDottedBorder extends StatefulWidget {
  final Color? color;
  ...
  @override
  State<AppDottedBorder> createState() => _AppDottedBorderState();
}

class _AppDottedBorderState extends State<AppDottedBorder> {
  @override
